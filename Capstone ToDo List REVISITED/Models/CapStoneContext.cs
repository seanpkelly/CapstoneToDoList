...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.\\SQLExpress;Database=CapStone;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Devs>(entity =>
            {
                ...
                entity.Property(e => e.TaskName).HasMaxLength(80);
                ...
                entity.HasOne(d => d.User)
                    .WithMany(p => p.Devs)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__Devs__UserId__6E01572D");
            });
